...
func main() {
	...
	realm := getenvDefault("KEYCLOAK_REALM", "wallet-app-demo")
	outputPath := getenvDefault("KEYCLOAK_TRUST_LIST_PATH", "examples/keycloak-issuer-verifier-app/keycloak-trustlist.jwt")
